            ...
            <div className="card">
              ...
              <div className="form-container">
                <div className="form-grid">
                  ...
                  {/* Project Symbol */}
                  <div className="form-group">
                    <label htmlFor="projectSymbol" className="form-label">Project Symbol</label>
                    <input
                      type="text"
                      id="projectSymbol"
                      name="projectSymbol"
                  ...
                  <div className="modal-footer_pd">
                    ...
                    {selectedProject.status === 'approved' && (
                      <button
                        ...
                        onClick={() => {
                          // Redirect to the minting page with project ID
                          window.location.href = `/projects?projectId=${selectedProject.id}`;
                        }}
                      >
